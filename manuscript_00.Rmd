...
We added X studies from X species and X tissues. 
...
## Pan mouse and human non-ocular references

The Tabula Muris and 
...
While scEiaD does not have spatial scRNA seq datasets as of 2022, we do leverage existing knowledge of the structure of the retina to show *in silico* visualization of genes by cell type / layer in a cartoon cross section of the retina. 

## Differential testing identifies many genes consistently enriched in various ocular cell types 

## Ocular specific gene signatures

## Fovea vs peripheral photoreceptor validation
...
## Design of scEiaD allows for projection of outside data
