...
```{r scEiaD_data_overview, fig.height = 35, fig.width = 25, echo = F, message = F, fig.cap=scEiaD_data_overview_cap}
tic()
...
feature_table %>% flextable() %>% width(., width = (w/(ncol(feature_table)))) 
# as of 2021 10 25
toc()
```
...
plot_grid(plot_grid(exp_plot_giga + theme(legend.position="none") + xlab(''),
          exp_plot_iovs + theme(legend.position="none") + ylab('') + xlab(''), labels = c('a','b')),
