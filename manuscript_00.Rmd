...
Many of these genes can be differentially expressed in more than one cell type. To identify genes that consistently differentially expressed we can use a more specific test. We define a consistent gene that is 
