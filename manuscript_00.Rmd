...
## Tease apart closely neurogenic and RPC cell types

As we see in Neurogenic and RPC have very similar expression patterns. We leverage our more specific pairwise differential test to directly assess genes that are different between neurogenic cells and RPC. We show the top 5 genes that are both more highly expressed in RPC relative to neurogenic cell and vice versa.

```{r, fig.width=15, fig.height=5, echo = F, message = F}
# tic()
