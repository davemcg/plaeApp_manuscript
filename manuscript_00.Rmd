...
cbind(consist_diff_genes, consist_diff_base) %>% as_tibble() %>% left_join(queries, by = c('consist_diff_genes' = 'Symbol', 'consist_diff_base' = 'Base')) 

rand_nums <- floor(runif(nrow(consist_diff_wide), min=0, max=3))
...
consist_diff_hm <- ComplexHeatmap::Heatmap(consist_diff_wide, 
                                           ...
                                           row_title_rot = 0) + 
  ComplexHeatmap::Heatmap(rand_nums,
                          row_split = consist_diff_base,
                          col = rand_col,
