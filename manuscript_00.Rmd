...
Yan et al. proposed a PRPH2 and RS1 as markers to distinguish fovea and peripheral located cones [@yan_cell_2020]. To see whether we could replicate these findings and propose new markers we perfomed a custom differntial test in human cones that were derived from studies that took retina punches from the fovea or peripheral regions. As this custom test was not 
